...
import numpy as np
import librosa
from utils.stft_for_preprocess import TacotronSTFT
from utils.utils import read_wav_np
from datasets.audio_processing_for_vocoder import pitch
...
def main(args, hp):
    ...
    mel_path = os.path.join(hp.data.output_dir, "mels")
    energy_path = os.path.join(hp.data.output_dir, "energy")
    pitch_path = os.path.join(hp.data.output_dir, "pitch")
